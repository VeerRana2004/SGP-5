...
import { language, cmtheme } from '../../src/atoms';  // Corrected import path
...
//                 <label>
//                     Select Language:
//                     <select value={lang} onChange={(e) => setLang(e.target.value)} className="seLang">
...
//                         <option value="3024-night">Dark</option>
